...
FINAL_IMAGE=${DISTDIR}/PC_02.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=PC02.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/PC02.o
POSSIBLE_DEPFILES=${OBJECTDIR}/PC02.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/PC02.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PC_02.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q84
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PC_02.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/PC02.o: PC02.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/PC02.o 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PC_02.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q84 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/PC_02.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
